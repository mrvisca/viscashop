...
<div class="content">
    ...
    <div class="top-bar">
        <!-- BEGIN: Breadcrumb -->
        <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Supplier</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">List Supplier</a> </div>
        <!-- END: Breadcrumb -->
        <!-- BEGIN: Notifications -->
    ...
    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
        ...
        <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
            <button class="button text-white bg-theme-1 shadow-md mr-2 tambah-pelanggan"> Tambah Supplier </button>
        </div>
    </div>
    <!-- BEGIN: Datatable -->
...
<script>
    $(document).ready(function() {
        ...
        var url = 'http://127.0.0.1:8000/api/supplier/list';
        fetch(url, {
            method: 'GET',
            headers: {
        ...
        function populateDataTable(data) {
            ...
            $(".ini-simpan").click(function() {
                ...
                $.ajax({
                        url: "http://127.0.0.1:8000/api/supplier/tambah-baru",
                        type: "POST",
            ...
            $(".ini-update").click(function() {
                ...
                $.ajax({
                    url: "http://127.0.0.1:8000/api/supplier/update-data/" + id,
                    type: "PUT",
                    beforeSend: function(xhr) {
                        xhr.setRequestHeader('Authorization', 'Bearer ' + token);
                    },
                    ...
                    success: function(response) {
                        ...
                        Swal.fire({
                            title: 'Berhasil',
                            text: 'Data supplier berhasil di Update.',
                            icon: 'success'
                        }).then(function() {
                    ...
                    error: function(xhr, status, error) {
                        ...
                        swal("Error!", "Terjadi kesalahan saat memperbarui data supplier.", "error");
                    }
                });
            });
            ...
            $('#data-table').on('click', '.btn-delete', function() {
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                    url: 'http://127.0.0.1:8000/api/supplier/hapus-data/' + id,
                    type: 'DELETE',
                    headers: {
                        'Authorization': 'Bearer ' + token
                    },
